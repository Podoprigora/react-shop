          ...
          {({ price, oldPrice, specialPrice, currency }) =>
            specialPrice ? (
              <div className="product-prices">
                <div className="product-price product-price--old">{moneyFormat(currency, oldPrice)}</div>
                <div className="product-price product-price--special">{moneyFormat(currency, specialPrice)}</div>
              </div>
            ) : (
